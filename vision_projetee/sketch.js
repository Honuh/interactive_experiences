...
let points2 = [
  ...
  { x: 100, y: -200, text: "Faire un système de particules animée en stop motion avec les Geonodes de Blender", check: false, category: 0},
...
let points3 = [
  ...
  { x: -100, y: -200, text: "Faire un collectif avec Louane", check: false, category: 3},
  { x: -100, y: -200, text: "Trouver le hangar", check: false, category: 3}
];
...
function preload() {
  ...
  noiseVideo = createVideo(['assets/noise.mp4']); 
}
...
function setup() {
  ...
  pointCol = color(220,220,220);

  noiseVideo.loop(); // Répéter la vidéo
  noiseVideo.hide(); // Cacher le lecteur vidéo
  noiseVideo.volume(0);
...
// Afficher la vidéo de bruit en fond
// tint(255,15);
// image(noiseVideo, 0, 0, width, height);
// tint(255);
